% This is a LaTeX template for the science and technical justifications of a European VLBI Network 
% observing proposal, following the initial instructions by the Polaris developers and adjusted to the 
% needs of the EVN.
% 
